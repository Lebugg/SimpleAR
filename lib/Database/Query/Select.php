...
use \SimpleAR\Database\Arborescence as Arbo;

use \SimpleAR\Database\Option\Filter;
use \SimpleAR\Database\Option\Group;
use \SimpleAR\Database\Option\Limit;
use \SimpleAR\Database\Option\Offset;
...
class Select extends Where
{
    ...
    protected function _buildFilter(Filter $o)
    {
    ...
    protected function _buildGroup(Group $o)
    {
    ...
    protected function _buildLimit(Limit $o)
    {
        $this->_limit = $o->limit;
    }

    protected function _buildOffset(Offset $o)
    {
        $this->_offset = $o->offset;
    }

    protected function _buildOrder(Order $o)
    {
        foreach ($o->groups as $group)
        {
            $this->_buildGroupOption($group);
    ...
    protected function _buildWith(With $o)
    {
        foreach ($o->groups as $group)
        {
            $this->_buildGroupOption($group);
