...
use \SimpleAR\Database\Option\Conditions;
...
abstract class Where extends Query
{
     ...
     * @return $this
     */
    public function _join($relation, $type = Arborescence::JOIN_INNER, $force = true)
    {
        $this->_useAlias = true;
    ...
    public function join($relation, $type = Arborescence::JOIN_INNER, $force = true)
    {
    ...
    protected function _buildConditions(Conditions $o)
    {
