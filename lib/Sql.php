...
class Sql
{
	...
	private function __construct($sRootModel)
	{
	...
	{
		$oBuilder = new self($oTable);
		return $oBuilder->_constructSelect($aOptions);
	}
	...
	private function _constructSelect($aOptions)
	{
		// These three following steps will initialize join arborescence and
		// values to select.
	...
	private function _normalizeCondition($sAttribute, $mValue, $sOperator, $sLogic, $oRelation)
	{
		$o = new \StdClass();
